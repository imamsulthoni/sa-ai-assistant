...
if (first === changedPrompt)
    throw new Error("Settings changes did not invalidate the agent fingerprint");
if (first === otherSession)
    throw new Error("Session context is not isolated in the agent fingerprint");
